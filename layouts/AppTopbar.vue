        ...
        <div class="max-w-7xl mx-auto flex justify-between items-center px-4">
            ...
            <nav class="items-center">
                <ul class="flex space-x-6">
                    ...
                    <li v-if="authAgency">
                        <div class="relative">
                            <button class="layout-topbar-menu-button hover:text-gray-300 transition-colors duration-200" @click="onTopBarMenuButton()">
                                <i class="pi pi-user"></i>
                                <span class="text-sm">{{ authAgency?.name }}님</span>
                            </button>
                            <div v-if="topbarMenuActive" class="absolute right-0 bg-[#F9F9F9] text-black rounded shadow-lg mt-2 p-4 dropdown-width">
                                ...
                                <div class="flex justify-center">
                                    <button @click="onSignOutClick" class="bg-[#6627AA] text-white px-4 py-2 rounded">로그아웃</button>
                                </div>
                            </div>
                        </div>
                    </li>
